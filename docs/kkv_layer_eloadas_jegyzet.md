...
Két dolgot kell megmutatni (az `f19` ábrán):

1. **A lánc együtt mozog.** Monetáris lazításra az export (+2,8%), a
   KKV-input az exportőrhöz (+3,0%) és a KKV-kibocsátás **együtt** nő —
   a beszállítói kapcsolat közösen reagál. Ez a vertikális link
   bizonyítéka.
2. **A KKV érzékenyebb.** Ugyanarra a sokkra a KKV-beruházás (+2,9%)
   erősebben reagál, mint a nagyvállalati (+2,1%) — a méretfüggő
   akcelerátor működik.

És egy technikai, de fontos pont: **a modell megoldódik** (a
Blanchard–Kahn feltétel teljesül — ez a DSGE „létezik és egyértelmű
megoldása van" tesztje). Ez nem magától értetődő, lásd a 9.2 alternatívát.
...
exportláncot versenyképesebbé teszi.
...
6. **(1 perc) Az eredmény.** Az f19 ábra: együttmozgás + aszimmetria. (8.)
