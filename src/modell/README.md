# DSGE-modellek (Dynare)

> ## Négy vonal, négy mappa — 2026-08-16 óta
>
> | Mappa | Mi ez | Státusz |
> |---|---|---|
> | **[`1_fo_vonal_jv/`](1_fo_vonal_jv/)** | Jakab–Világi mag, háromtípusos. **A leadandó: `jv_dsge_v09_access.mod`** | 🟢 élő |
> | [`2_referencia_eagle/`](2_referencia_eagle/) | EAGLE-HU mag — robusztussági összevetés | 🟡 referencia |
> | [`3_archiv_korai_jv/`](3_archiv_korai_jv/) | meghaladott JV-lépcsők (v01–v05) + a `_stoch` nyitott tétel | ⚪ archív |
> | [`4_app/`](4_app/) | a Streamlit-app futtató-modellje | 🟡 külön termék |
>
> Mindegyik mappa ugyanúgy épül fel: **`README.md` + `.mod` fájlok +
> `futtato/`**. Az egyes mappák README-je mondja meg, mi van benne, mit
> bizonyít, és hogyan kell futtatni.
>
> **Amit tudni kell a vágásról:** a fő vonalban a `v06`–`v08` **nem
> alternatíva és nem elvetett** — a `v09` levezetésének lépcsői, a füstteszt
> őrei rajtuk állnak, és a `v09` nesting-tesztje egyszerre futtatja a
> `v08`-at és a `v09`-et. Ezért maradtak együtt.
>
> Az alábbi rész a **per-verzió changelog** — a projekt története. Az
> aktuális állapotot az [`ALLAPOT.md`](../../ALLAPOT.md) viszi.
...
```
matlab -batch "cd('src/modell/2_referencia_eagle/futtato'); run_v02"
```
...
```
matlab -batch "cd('src/modell/2_referencia_eagle/futtato'); run_v01"
```
