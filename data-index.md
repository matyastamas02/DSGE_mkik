...
| **input-output (ÁKM)** | A hazai köztes input aránya ágazatonként — az `s_kkv` modellparaméter empirikus alapja. **Eredmény: az autóipar köztes felhasználásának csak 6,0%-a hazai** (elektronika 4,2%, vegyipar 27,1%); export-mag átlag 0,054. | Eurostat `naio_10_cp1620`/`cp1630` + `nama_10_a64` (a KSH szolgáltatja be; ksh.hu közvetlenül nem volt elérhető) | API-ból, script: `src/07_io_hazai_input_arany.py` | `output/tables/t24_io_hazai_input.csv` | **kész** (2026-07) |
